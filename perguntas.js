...
criaCartao(
    'Causa',
    'O que o desmatamento pode causar aos animais?',
    'O desmatamento tem um impacto devastador nos animais, levando à perda de habitat, redução da biodiversidade, aumento do risco de predação e extinção de espécies. A derrubada de árvores elimina os locais onde os animais vivem, se reproduzem e se alimentam, forçando-os a migrar ou a morrer. A perda de habitat também interrompe a cadeia alimentar, afetando a disponibilidade de alimentos e aumentando a competição entre as espécies. '
)